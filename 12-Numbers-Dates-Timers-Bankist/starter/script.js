...
const account1 = {
  ...
  movementsDates: [
    ...
    '2026-09-08T14:11:59.604Z',
    '2020-05-27T17:01:17.194Z',
    '2026-09-12T18:49:59.371Z',
    '2026-09-10T12:01:20.894Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
const displayMovements = function (acc, sort = false) {
  ...
  // const combineMovsDates = acc.movements.map((mov, i) => ({ movement: mov, movementDate: acc.movementsDates.at(i) }));
  // console.log(combineMovsDates);

  // if (sort) {
  //   combineMovsDates.sort((a, b) => a.movement - b.movement)
  // }
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +(inputLoginPin.value)) {
    ...
    console.log(new Intl.DateTimeFormat('ta-ta').format(now));
...
// isFinite
// Don't use isNan to check if the value is number instead use isFinite
...
// Math.PI -> To find radius
console.log(Math.PI * Number.parseFloat('10px') ** 2);

// Math.random() -> to get random number
// Math.trunc() -> to get round number without decimal value
...
const days1 = Math.round(calcDaysPassed(new Date(2037, 3, 14), new Date(2037, 3, 4, 10, 6)));
console.log(days1);
*/
...
console.log('TAMIL:   ', new Intl.NumberFormat('ta-ta', options).format(num));
...
setInterval(function () {
  const now = new Date();
  console.log(now);
  console.log(`Time is => ${now.getHours()}:${now.getMinutes()}:${now.getSeconds()}`);
}, 1000)
*/