...
// 3
/*
let averageTimeOfFootball = 0;
for (const min of gameEvents.keys()) {
  console.log(min);
  averageTimeOfFootball += min;
}
console.log(averageTimeOfFootball);
averageTimeOfFootball /= gameEvents.size
console.log(averageTimeOfFootball);
console.log(`An event happened, on average: ${averageTimeOfFootball}, every 9 minutes`);
*/
...
const averageTimeOfFootball = time / eventsCount;

console.log(`An event happened, on average, every ${averageTimeOfFootball} minutes`);
*/
...
button.addEventListener('click', function () {
  ...
  for (const [i, row] of rows.entries()) {
    ...
    const camelCase = first + last[0].toUpperCase() + last.slice(1);
